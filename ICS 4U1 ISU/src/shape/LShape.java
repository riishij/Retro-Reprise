/*
 * Purpose: Stores the attributes and methods for the LShape
 */
package shape;

import java.util.ArrayList;

public class LShape extends Shape implements ComplexRotate{
	//constructor 
	public LShape(int startingXLocation,int startingYLocation) {
	...
	public boolean rotateTo2Check(ArrayList<Shape> shapes,int numSquares,String[][] grid) {
		...
		if(shapes.get(numSquares-2).getXLocationLeft()>50) { 
			int num1=((shapes.get(numSquares-4).getYLocationTop()-30)/15);
			int num2=((shapes.get(numSquares-4).getXLocationLeft()-50)/15)-1;
			int num3=((shapes.get(numSquares-3).getYLocationTop()-30)/15);
			int num4=((shapes.get(numSquares-3).getXLocationLeft()-50)/15)-1;
			int num5=((shapes.get(numSquares-4).getYLocationTop()-30)/15);
			int num6=((shapes.get(numSquares-4).getXLocationLeft()-50)/15)+1;
			...
			else if(grid[num5][num6].equals("full")) {		
				return false;
			}
			else {
				return true;
	...
	public boolean rotateTo3Check(ArrayList<Shape> shapes,int numSquares,String[][] grid) {
		...
		if(shapes.get(numSquares-2).getYLocationTop()<300) { 
			//checks if the shape will hit any other shapes if it rotates
			int num1=((shapes.get(numSquares-3).getYLocationTop()-30)/15)+1;
			int num2=((shapes.get(numSquares-3).getXLocationLeft()-50)/15);
			int num3=((shapes.get(numSquares-3).getYLocationTop()-30)/15)+2;
			int num4=((shapes.get(numSquares-3).getXLocationLeft()-50)/15);
			if(grid[num1][num2].equals("full")) {	
				return false;		
			}
			else if(grid[num3][num4].equals("full")) {	
	...
	public boolean rotateTo4Check(ArrayList<Shape> shapes,int numSquares,String[][] grid) {
		//checks if the shape will rotate out of the board
		if(shapes.get(numSquares-1).getXLocationLeft()<185) { 
			//checks if the shape will hit any other shapes if it rotates
			int num1=((shapes.get(numSquares-1).getYLocationTop()-30)/15);
			int num2=((shapes.get(numSquares-1).getXLocationLeft()-50)/15)+1;
			int num3=((shapes.get(numSquares-2).getYLocationTop()-30)/15);
			int num4=((shapes.get(numSquares-2).getXLocationLeft()-50)/15)+1;
			int num5=((shapes.get(numSquares-1).getYLocationTop()-30)/15);
			int num6=((shapes.get(numSquares-1).getXLocationLeft()-50)/15)-1;
			if(grid[num1][num2].equals("full")) {	
				return false;		
			}
			else if(grid[num3][num4].equals("full")) {	
	...
	public boolean rotateTo1Check(ArrayList<Shape> shapes,int numSquares,String[][] grid) {
		...
		int num3=((shapes.get(numSquares-2).getYLocationTop()-30)/15)-2;
