/*
 * Purpose: Stores the attributes and methods for the JShape
 */
package shape;

import java.util.ArrayList;

public class JShape extends Shape implements ComplexRotate{
	//declare position variable
	private int position;
	
	//constructor
	public JShape(int startingXLocation,int startingYLocation) {
	...
	public boolean rotateTo2Check(ArrayList<Shape> shapes,int numSquares,String[][] grid) {
		//checks if the shape if too far left
	...
	public boolean rotateTo1Check(ArrayList<Shape> shapes,int numSquares,String[][] grid) {
		...
		if(shapes.get(numSquares-1).getYLocationTop()<300) { 
			...
			int num4=((shapes.get(numSquares-1).getXLocationLeft()-50)/15)-1;
