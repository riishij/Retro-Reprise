/*
 * Purpose: Stores the attributes and methods for the SShape
 */
package shape;

import java.util.ArrayList;

public class SShape extends Shape implements SimpleRotate{
	//declare position variable
	int position;

	//constructor
	public SShape(int startingXLocation,int startingYLocation) {
